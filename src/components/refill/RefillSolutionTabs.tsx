 ...
 * no-shows (Reminders, the old Preshow agent) and RECOVERS them (Refill, the
 * old Refill agent), with the recovery dashboard as the Overview. Dissolves
...
const TABS: Array<{
  ...
  { key: "rescue", to: "/app/refill/recovery/rescue", label: "Refill", Icon: LifeBuoy },
