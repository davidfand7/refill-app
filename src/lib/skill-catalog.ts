...
export const SKILL_CATALOG: SkillTemplate[] = [
  ...
  },
  {
    ...
    description:
      "When an appointment cancels, offer the freed slot to the best-fit waitlist patient — low-confidence fits are held for your one-tap OK. Adopting this turns on your Refill routine; fine-tune the eligible treatments and limits in Refill.",
    solution: "refill",
    materializer: "routine",
    status: "live",
    adoptCopy:
      "Turns on rescue so canceled slots get filled from your waitlist — then opens Refill so you can set the rules.",
