  ...
  return (
    <div className="min-h-screen bg-background">
      <PageHeader
        ...
        description="Refill's agents (Preshow, Refill, Attribution, Recognition Allocation) and the global defaults that govern them. Defaults apply to every spa; add an override when a tenant, rep, or user needs the exception. Every toggle is audit-logged."
        breadcrumbs={[
