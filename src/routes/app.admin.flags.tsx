  ...
  return (
    <div className="min-h-screen bg-background">
      <PageHeader
        eyebrow="Admin"
        title="Feature flags"
        description="Tune what Refill does. Defaults work for every spa; add an override only when a tenant, rep, or user needs the exception. Every toggle is audit-logged."
        breadcrumbs={[
