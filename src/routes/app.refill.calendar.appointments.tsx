...
export const Route = createFileRoute("/app/refill/calendar/appointments")({
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageHeader wide
        eyebrow="Calendar"
        title="Appointments"
        description="Drop your PMS export (Acuity, Boulevard, Mangomint, Vagaro, AestheticsPro, Aesthetic Record — auto-detected). SmartSpa keeps your schedule in sync."
        breadcrumbs={[
          { label: "Calendar", to: "/app/refill/calendar/schedule" },
          { label: "Appointments" },
        ]}
        actions={
          <button
      ...
      />
      <CalendarTabs active="appointments" />
