/**
 * /app/refill/calendar/zenoti-install — Zenoti paste-CenterID wizard (v1.41.0;
...
export const Route = createFileRoute("/app/refill/calendar/zenoti-install")({
...
function ZenotiInstallPage() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      else if (resp.ok) window.location.href = "/app/refill/calendar/connections?scheduler_connected=zenoti";
      else {
