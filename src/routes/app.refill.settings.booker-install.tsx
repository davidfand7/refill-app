/**
 * /app/refill/settings/booker-install — Booker paste-LocationID wizard (v1.39.0).
 *
...
function BookerInstallPage() {
  const search = useSearch({ from: "/app/refill/settings/booker-install" });
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (resp.redirected) {
        ...
        window.location.href = "/app/refill/settings/scheduler?scheduler_connected=booker";
      } else {
