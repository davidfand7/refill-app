/**
 * /app/refill/settings/vagaro-install — Vagaro install wizard
...
function VagaroInstallPage() {
  const search = useSearch({ from: "/app/refill/settings/vagaro-install" });
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (resp.redirected) {
        ...
        window.location.href = "/app/refill/settings/scheduler?scheduler_connected=vagaro";
      } else {
