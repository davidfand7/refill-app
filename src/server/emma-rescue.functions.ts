 ...
 */
// v2.201.0: resolveDelivery / queueAllows / enqueueOutboundImessage moved to the
// shared `outbound-delivery.ts` so the Deal Desk's promo deploy (allocation) can
// reuse the same zero-setup queue lane. Behavior unchanged — imported above.
